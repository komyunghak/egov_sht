...
<script type="text/javascript">
    ...
    function fn_egov_delete_notice() {
        ...
        if (confirm('<spring:message code="common.delete.msg" />')) {  //정말로 삭제하시겠습니까 ? 창 뜨게하는 문
    ...
    function fn_egov_addReply() {
        document.frm.action = "<c:url value='/admin/board/ReplyBoard.do'/>";
        document.frm.submit();          
    }   
</script>
