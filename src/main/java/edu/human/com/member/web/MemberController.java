...
public class MemberController {
  ...
  */
  ...
  public String adminDeleteMember(@RequestParam("EMPLYR_ID") String emplyr_id, Model model) throws Exception {
   ...
   /**
   AdminLTE용 관리자관리 입력 POST. 200821
  */
